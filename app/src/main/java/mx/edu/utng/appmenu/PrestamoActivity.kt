    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnCalcular.setOnClickListener(){
            if (rdb6meses.isChecked){
                ...
                var i = interes/12
                var pagosMensuales=monto*((Math.pow((1+i),6.0) * i)/(Math.pow((1+i),6.0) - 1))
                ...
                var interes = interesAnual/100
                var i = interes/12
                var pagosMensuales=monto*((Math.pow((1+i),12.0) * i)/(Math.pow((1+i),12.0) - 1))
                ...
                var interes = interesAnual/100
                var i = interes/12
                var pagosMensuales=monto*((Math.pow((1+i),18.0) * i)/(Math.pow((1+i),18.0) - 1))
                ...
                var pagosMensuales=monto*((Math.pow((1+i),24.0) * i)/(Math.pow((1+i),24.0) - 1))
               ...
               var mensaje = "No se realizo ningun cálulo"
